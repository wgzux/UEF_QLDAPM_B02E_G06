...
@section('content')
    ...
    <section class="section container intro-section">
        <div class="row">
            <div class="col-text text-right">
                ...
                <a href="/about" class="btn btn-outline-primary">XEM THÊM <i class="fa-solid fa-arrow-right"></i></a>
            </div>
            <div class="col-img">
        ...
        <div class="services-grid container">
            <div class="service-item" style="background-image: url('https://images.unsplash.com/photo-1530103862676-de3c9a59aa57?q=80&w=2070&auto=format&fit=crop');">
                <div class="service-overlay">
                    ...
                    <a href="/booking" class="btn btn-outline-light btn-sm">ĐẶT LỊCH</a>
                </div>
            </div>
    ...
    <section class="cta-section bg-primary text-center">
        <div class="container">
            ...
            <a href="/booking" class="btn btn-light text-primary">BOOK PHÒNG</a>
        </div>
    </section>
