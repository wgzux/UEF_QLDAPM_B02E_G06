...
@section('title', 'Trải Nghiệm Bản Địa - The Wandering Rose')

@section('content')

{{-- Hero Header --}}
<section class="relative h-[80vh] flex items-center justify-center overflow-hidden">
    <img src="https://images.unsplash.com/photo-1504609813442-a8924e83f76e?w=1600&h=1000&fit=crop" 
    ...
    <div class="relative z-10 text-center text-white">
        <h1 class="font-display text-5xl md:text-7xl mb-8 font-light italic">Các trải nghiệm bản địa</h1>
...
<section class="bg-[#FDFBF7] py-20 px-6">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
            <img src="https://images.unsplash.com/photo-1504609813442-a8924e83f76e?w=900&h=700&fit=crop" 
                 alt="Trải nghiệm bản địa" 
            ...
            <ul class="space-y-3 text-gray-600 font-light text-sm italic list-disc list-inside">
                <li>Giao lưu văn hóa với người dân địa phương</li>
                <li>Thưởng thức ẩm thực đặc sản vùng miền</li>
                <li>Tìm hiểu các làng nghề truyền thống</li>
                <li>Tham gia các hoạt động nông nghiệp</li>
                <li>Trải nghiệm lối sống giản dị, gần gũi</li>
                <li>Mua sắm đặc sản, quà tặng thủ công</li>
            </ul>
        </div>
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <select name="service" required
                        ...
                        <option value="ban-dia">Trải nghiệm bản địa</option>
                    </select>
                </div>
