...
@section('title', 'Tour Ao Vua - The Wandering Rose')

@section('content')

{{-- Hero Header --}}
<section class="relative h-[80vh] flex items-center justify-center overflow-hidden">
    <img src="https://images.unsplash.com/photo-1609137144813-7d9921338f24?w=1600&h=1000&fit=crop" 
         alt="Tour Ao Vua" 
         class="absolute inset-0 w-full h-full object-cover">
    <div class="absolute inset-0 bg-gradient-to-b from-black/30 via-black/30 to-black/30"></div>
    <div class="relative z-10 text-center text-white">
        <h1 class="font-display text-5xl md:text-7xl mb-8 font-light italic">Tour Ao Vua</h1>
...
<section class="max-w-7xl mx-auto px-6 py-20">
    <div class="text-center max-w-3xl mx-auto mb-16">
        ...
        <p class="text-gray-600 leading-relaxed font-light">
            Khu du lịch Ao Vua nằm dưới chân núi Tản Viên huyền thoại, nơi gắn liền với truyền thuyết Sơn Tinh - Thủy Tinh. Tại đây, bạn có thể tham gia các trò chơi cảm giác mạnh, tắm thác suối tự nhiên và tận hưởng bầu không khí mát mẻ, trong lành của vùng núi Ba Vì.
        </p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <img src="https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&h=600&fit=crop" 
             alt="Ao Vua waterfall" 
             class="w-full aspect-[4/3] object-cover rounded shadow-lg">
        <img src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=800&h=600&fit=crop" 
             alt="Lake view" 
             class="w-full aspect-[4/3] object-cover rounded shadow-lg">
    </div>
</section>
...
<section class="bg-[#FDFBF7] py-20 px-6">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
            <img src="https://images.unsplash.com/photo-1609137144813-7d9921338f24?w=900&h=700&fit=crop" 
                 alt="Tour Ao Vua" 
            ...
            <ul class="space-y-3 text-gray-600 font-light text-sm italic list-disc list-inside">
                <li>Tham quan hồ Ao Vua và núi Tản Viên huyền thoại</li>
                <li>Trải nghiệm các trò chơi cảm giác mạnh</li>
                <li>Tắm thác suối tự nhiên trong lành</li>
                <li>Thưởng thức ẩm thực địa phương đặc sắc</li>
                <li>Hướng dẫn viên chuyên nghiệp, nhiệt tình</li>
                <li>Phương tiện di chuyển an toàn, thoải mái</li>
            </ul>
        </div>
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <select name="service" required
                        ...
                        <option value="ao-vua">Tour Ao Vua</option>
