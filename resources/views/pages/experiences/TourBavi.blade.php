...
@section('title', 'Tour Vườn Quốc Gia Ba Vì - The Wandering Rose')

@section('content')

{{-- Hero Header --}}
<section class="relative h-[80vh] flex items-center justify-center overflow-hidden">
    <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1600&h=1000&fit=crop" 
    ...
    <div class="relative z-10 text-center text-white">
        <h1 class="font-display text-5xl md:text-7xl mb-8 font-light italic">Tour khám phá<br>Vườn Quốc gia Ba Vì</h1>
...
<section class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <img src="https://images.unsplash.com/photo-1511497584788-876760111969?w=800&h=600&fit=crop" 
             alt="Đường rừng Ba Vì" 
...
<section class="bg-[#FDFBF7] py-20 px-6">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
            <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=900&h=700&fit=crop" 
                 alt="Vườn Quốc Gia Ba Vì" 
            ...
            <ul class="space-y-3 text-gray-600 font-light text-sm italic list-disc list-inside">
                <li>Khám phá các phế tích thời Pháp cổ kính</li>
                <li>Đường trekking dẫn lối đến đỉnh núi cao</li>
                <li>Rừng thông mộng mơ và không khí trong lành</li>
                <li>Tham quan các thác nước và suối tự nhiên</li>
                <li>Hướng dẫn viên chuyên nghiệp, am hiểu địa phương</li>
                <li>Cung cấp đầy đủ thiết bị trekking an toàn</li>
            </ul>
        </div>
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <select name="service" required
                        ...
                        <option value="tour-bavi">Tour Vườn Quốc Gia Ba Vì</option>
