...
@section('title', 'Tổ Chức Sinh Nhật - The Wandering Rose')

@section('content')

{{-- Hero Header --}}
<section class="relative h-[80vh] flex items-center justify-center overflow-hidden">
    <img src="https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=1600&h=1000&fit=crop" 
         alt="Birthday celebration" 
         class="absolute inset-0 w-full h-full object-cover">
    <div class="absolute inset-0 bg-gradient-to-b from-black/30 via-black/30 to-black/30"></div>
    <div class="relative z-10 text-center text-white">
        <h1 class="font-display text-5xl md:text-7xl mb-8 font-light italic">Tổ chức sinh nhật</h1>
...
<section class="max-w-7xl mx-auto px-6 py-20">
    <div class="text-center max-w-3xl mx-auto mb-16">
        ...
        <p class="text-gray-600 leading-relaxed font-light">
            Tổ chức tiệc sinh nhật tại The Wandering Rose mang đến không gian sang trọng và ấm cúng, phù hợp cho mọi độ tuổi. Chúng tôi cung cấp đầy đủ dịch vụ trang trí, âm thanh, ánh sáng và catering theo yêu cầu, tạo nên một bữa tiệc đáng nhớ cho bạn và những người thân yêu.
        </p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <img src="https://images.unsplash.com/photo-1464349095431-e9a21285b2df?w=800&h=600&fit=crop" 
             alt="Birthday party setup" 
             class="w-full aspect-[4/3] object-cover rounded shadow-lg">
        <img src="https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=800&h=600&fit=crop" 
             alt="Birthday celebration" 
             class="w-full aspect-[4/3] object-cover rounded shadow-lg">
    </div>
</section>
...
<section class="bg-[#FDFBF7] py-20 px-6">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
            <img src="https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=900&h=700&fit=crop" 
            ...
            <ul class="space-y-3 text-gray-600 font-light text-sm italic list-disc list-inside">
                <li>Không gian riêng tư cho 20-100 khách</li>
                <li>Trang trí theo chủ đề và màu sắc yêu thích</li>
                <li>Hệ thống âm thanh, ánh sáng chuyên nghiệp</li>
                <li>Dịch vụ catering cao cấp, thực đơn đa dạng</li>
                <li>Hỗ trợ tổ chức các trò chơi, hoạt động vui chơi</li>
                <li>Dịch vụ chụp ảnh, quay video chuyên nghiệp</li>
            </ul>
        </div>
